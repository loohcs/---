//
//  AKApproveDailyContentViewController.m
//  医药通
//
...
@interface AKApproveDailyContentViewController ()
...
@implementation AKApproveDailyContentViewController
...
- (void)viewDidLoad
{
    ...
    UILabel *topItemLabel = [AKFastLabel labelWithFrame:CGRectMake(0, 0, 180, 30) andText:@"员工日报" andtextAlignment:UITextAlignmentCenter andFont:18];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    AKApproveDailyDetailsViewController *approveDailyDetailsVC = [[AKApproveDailyDetailsViewController alloc]init];
    approveDailyDetailsVC.detailsId = idStr;
    [self.navigationController pushViewController:approveDailyDetailsVC animated:NO];
    [approveDailyDetailsVC release];
}
