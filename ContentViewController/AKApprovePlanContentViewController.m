//
//  AKApprovePlanContentViewController.m
//  医药通
//
...
@interface AKApprovePlanContentViewController ()
...
@implementation AKApprovePlanContentViewController
...
- (void)viewDidLoad
{
    ...
    UILabel *topItemLabel = [AKFastLabel labelWithFrame:CGRectMake(0, 0, 180, 30) andText:@"员工计划" andtextAlignment:UITextAlignmentCenter andFont:18];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    AKApprovePlanDetailsViewController *approvePlanDetailsVC = [[AKApprovePlanDetailsViewController alloc]init];
    approvePlanDetailsVC.detailsId = idStr;
    [self.navigationController pushViewController:approvePlanDetailsVC animated:NO];
    [approvePlanDetailsVC release];
}
