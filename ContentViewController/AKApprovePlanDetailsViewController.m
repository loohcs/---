//
//  AKApprovePlanDetailsViewController.m
//  医药通
//
...
#import "AKApprovePlanDetailsViewController.h"
...
@interface AKApprovePlanDetailsViewController ()
-(void)ransmitRequest;//发送请求
-(void)refreshContent;//刷新
@end

@implementation AKApprovePlanDetailsViewController
...
- (void)addDetails
{
    label1 = [AKFastLabel labelWithFrame:CGRectMake(_START_INTERVAL_, 0, 320, _LINE_HEIGHT_) andText:@"  计划标题：" andtextAlignment:UITextAlignmentLeft andFont:_LABEL_FONT_ andTextColor:[UIColor blackColor] andBackgroundColor:[UIColor colorWithRed:0.75f green:0.75f blue:0.75f alpha:1]];
    ...
    label3 = [AKFastLabel labelWithFrame:CGRectMake(_START_INTERVAL_, 40, 320, _LINE_HEIGHT_) andText:@"  提交时间：" andtextAlignment:UITextAlignmentLeft andFont:_LABEL_FONT_ andTextColor:[UIColor blackColor] andBackgroundColor:_LABEL_BACK_COLOR_];
    label4 = [AKFastLabel labelWithFrame:CGRectMake(_START_INTERVAL_, 60, 320, _LINE_HEIGHT_) andText:@"  计划时间：" andtextAlignment:UITextAlignmentLeft andFont:_LABEL_FONT_-1 andTextColor:[UIColor blackColor] andBackgroundColor:_LABEL_BACK_COLOR_];
    ...
    UIView *intervalView4 = [AKFastView viewWithWithFrame:CGRectMake(0, 79, 320, 1) andBackgroundColor:[UIColor blackColor]];
    textView1 = [AKFastTextView textViewNormalWithFrame:CGRectMake(0, 77, 320, 64) andBackgroundColor:[UIColor clearColor] andKeyboardType:UIKeyboardTypeDefault andFont:_LABEL_FONT_-2];
    textView1.editable = NO;
    UIView *intervalView5 = [AKFastView viewWithWithFrame:CGRectMake(0, 144, 320, 1) andBackgroundColor:[UIColor blackColor]];
    ...
    [self.view addSubview:intervalView5];
...
- (void)viewDidLoad
{
    ...
    UILabel *topItemLabel = [AKFastLabel labelWithFrame:CGRectMake(0, 0, 180, 30) andText:@"计划详情" andtextAlignment:UITextAlignmentCenter andFont:18];
...
-(void)ransmitRequest//发送请求
{
    ...
    [currentRequest currentRequestWithURL:_YGJIHUA_INTERFACE_ andParameter:aParameterDic];
}
-(void)refreshContent//刷新
{
    [self ransmitRequest];
...
-(void)approveBegin//确定批复
{
    ...
    [parameterCurrentRequest parameterCurrentRequestWithURL:_YGJIHUA_INTERFACE_ andParameter:aParameterDic];
...
-(void)refreshSucceedWithContentDictionary:(NSDictionary*)aContentDic
{
    ...
    if ([flagStr isEqualToString:@"success"]) {
        NSArray *listArray1 = [aContentDic objectForKey:@"personalplandetail"];
        NSDictionary *personalDic = [NSDictionary dictionaryWithDictionary:[listArray1 lastObject]];
        NSString *label1Str = [NSString stringWithFormat:@"  计划标题：%@",[personalDic objectForKey:@"Title"]];
        NSString *label2Str = [NSString stringWithFormat:@"  员工姓名：%@",[personalDic objectForKey:@"Employ"]];
        NSString *label3Str = [NSString stringWithFormat:@"  提交时间：%@",[personalDic objectForKey:@"Createtime"]];
        NSString *label4Str = [NSString stringWithFormat:@"  计划时间：%@~%@",[personalDic objectForKey:@"Stime"],[personalDic objectForKey:@"Etime"]];
        ...
        label4.text = label4Str;
        textView1.text = textView1Str;
        NSArray *listArray2 = [aContentDic objectForKey:@"personalplanreply"];
        if (listArray2.count) {
            [cellViewArray setArray:[AKFastCallView planDetailsCellViewWithArray:listArray2]];
