//
//  AKApproveDailyContentViewController.h
//  医药通
//
...
@interface AKApproveDailyContentViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,currentRefreshDelegate>
{
