...
+(UILabel*)labelWithFrame:(CGRect)aFrame andText:(NSString*)aText andtextAlignment:(NSTextAlignment)aTextAlignment andFont:(NSInteger)aFont andTextColor:(UIColor*)aColor andBackgroundColor:(UIColor*)aBackgroundColor
{
    UILabel *Label = [[UILabel alloc]initWithFrame:aFrame];
